...
// FIX: Updated imports to be relative paths, assuming all these
// components have been moved into the 'app/ui' folder.
  ...
  return (
    ...
    >
      <Image
        ...
        style={{ width: 'auto', height: '100%' }} // Fix for the image warning
      />
    </Link>
  );
}